...
final class MLXtraChatLayoutUITests: XCTestCase {
    ...
    private static let runScreenshotDirectory = FileManager.default.temporaryDirectory
        .appendingPathComponent("MLXtraChatLayoutScreenshots", isDirectory: true)
    ...
    override func setUpWithError() throws {
        ...
        if name.contains("testTranscriptLiftsAboveExpandedMusicComposer") {
            app.launchEnvironment["MLXTRA_UI_TEST_WINDOW_WIDTH"] = "980"
            app.launchEnvironment["MLXTRA_UI_TEST_WINDOW_HEIGHT"] = "640"
        } else if name.contains("testNarrowWindowMessageAndComposerWidths") {
            app.launchEnvironment["MLXTRA_UI_TEST_WINDOW_WIDTH"] = "860"
            app.launchEnvironment["MLXTRA_UI_TEST_WINDOW_HEIGHT"] = "680"
        } else if name.contains("testFullWidthPlainMessageRail") {
            app.launchEnvironment["MLXTRA_UI_TEST_WINDOW_WIDTH"] = "1460"
            app.launchEnvironment["MLXTRA_UI_TEST_WINDOW_HEIGHT"] = "900"
        }
        if name.contains("testComposerModelLoadingIndicatorDoesNotResizeComposer") {
            app.launchEnvironment["MLXTRA_UI_TEST_FORCE_MODEL_LOADING_INDICATOR"] = "1"
        }
        ...
        if name.contains("testCollapsedSidebarShowsToolbarNewChatButton") {
            app.launchEnvironment["MLXTRA_UI_TEST_HIDE_SIDEBAR"] = "1"
        }
    ...
    func testModelParameterPopoverLayoutSnapshot() throws {
        ...
        XCTAssertTrue(advanced.waitForExistence(timeout: 5), "Advanced disclosure title should be clickable")
        advanced.click()
        XCTAssertTrue(app.staticTexts["Top P"].waitForExistence(timeout: 3), "Clicking Advanced text should reveal advanced parameters")
    ...
    func testSettingsWindowLayoutSnapshot() throws {
        ...
        let window = app.windows["MLXtra Settings"]
