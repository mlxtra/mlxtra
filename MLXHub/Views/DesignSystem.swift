...
extension View {
    ...
    func designPanelSurface(cornerRadius: CGFloat = MLXHubDesignSystem.Radius.card) -> some View {
        self
            .background(MLXHubDesignSystem.Surface.panelFill, in: RoundedRectangle(cornerRadius: cornerRadius, style: .continuous))
            .overlay {
    ...
    func designContentSurface(cornerRadius: CGFloat = MLXHubDesignSystem.Radius.card) -> some View {
        self
            .background(MLXHubDesignSystem.Surface.contentFill, in: RoundedRectangle(cornerRadius: cornerRadius, style: .continuous))
            .overlay {
                RoundedRectangle(cornerRadius: cornerRadius, style: .continuous)
                    .stroke(MLXHubDesignSystem.Surface.quietHairline, lineWidth: 1)
            }
    ...
    func designTintSurface(
        _ tint: Color,
        cornerRadius: CGFloat = MLXHubDesignSystem.Radius.control
    ) -> some View {
        self
            .background(MLXHubDesignSystem.Surface.tintFill(tint), in: RoundedRectangle(cornerRadius: cornerRadius, style: .continuous))
            .overlay {
                RoundedRectangle(cornerRadius: cornerRadius, style: .continuous)
...
struct NativeSearchField: NSViewRepresentable {
    ...
    func makeNSView(context: Context) -> NSSearchField {
        ...
        field.font = MLXHubDesignSystem.Typography.nativeSearchFieldFont()
